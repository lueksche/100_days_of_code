...
class Snake():
    ...
    def move(self):
        ...
        self.segments_list[0].forward(MOVING_DISTANCE)

    
    def left_key(self):
        self.segments_list[0].setheading(180)

    def right_key(self):
        self.segments_list[0].setheading(0)

    def up_key(self):
        self.segments_list[0].setheading(90)

    def down_key(self):
        self.segments_list[0].setheading(270)